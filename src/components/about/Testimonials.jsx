        ...
        <>
            <section>
                ...
                <div className='items-center justify-center relative py-10'>
                    <img src={about2} alt="Card Image" className="absolute top-20 left-32 -z-50 sm:w-50 sm:top-0 sm:left-16" />
                    <img src={about1} alt="Card Image" className="absolute top-10 left-20 -z-50 sm:w-50 sm:-top-5 sm:left-5" />
                    <div className='relative sm:my-10 mx-60 sm:mx-2 my-10'>
                        <img src={about} alt="Card Image" className="absolute -top-11 right-0 -z-50 sm:w-50 sm:-right-0" />
                        <div className="bg-white justify-center items-center text-center mx-20 px-20 sm:m-5 sm:p-5 relative">
                            ...
                            <div className='flex py-10'>
                                <span className='text-span text-[200px] absolute left-10 top-0'>“</span>
                                ...
                                <span className='text-span text-[200px] absolute right-10 -bottom-7 rotate-180'>“</span>
                            </div>
                            <div className="triangle rotate-180 w-10 h-20"></div>
                        </div>
                        <img src={about} alt="Card Image" className="absolute -bottom-10 left-0 -z-50 sm:w-50" />
                    </div>
                    <img src={about1} alt="Card Image" className="absolute bottom-20 right-32 -z-50 sm:w-50 sm:bottom-0 sm:right-16" />
                    <img src={about2} alt="Card Image" className="absolute bottom-10 right-20 -z-50 sm:w-50 sm:-bottom-5 sm:right-5" />
                </div>
            </section>
        </>
    )
