    ...
    <>
      <section className="mt-40 mb-40">
        <div className="text-center">
          ...
          <p className="text-fontSize4">
            Have questions or need assistance? Contact us today.
          </p>
          <p className="text-fontSize4">
            We’re here to help you on your learning journey, so don’t hesitate
            to reach out!
          </p>
        </div>
          ...
          <div className="flex-1">
            <div className="block border border-none my-10">
              <div className="flex flex-col gap-7">
                ...
                <button
                  href="#"
                  className="background3 text-black text-fontSize3 py-2 px-4 mx-20 rounded-[30px] border border-black flex justify-center items-center gap-3"
                >
                  Send Message <PiPaperPlaneTilt className=" text-fontSize2" />
                </button>
              </div>
            </div>
          </div>
