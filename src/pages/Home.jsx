  ...
  return (
    <>
      ...
      >
            ...
            <div className="flex items-center ml-40">
              ...
              <div className="mt-10">
                <NavLink to="/getstarted">
                  <button className="background3 hover:bg-white mr-10 w-full text-white font-bold py-2 px-4 rounded">
                    Get Started
                  </button>
                </NavLink>
              </div>
        ...
        <div className="-mt-14" style={{ backgroundImage: `url(${back})` }}>
          {/* Arrow and the spiral background image section */}
          <div className="flex justify-between mb-0">
            <div className="ml-30 mt-40  w-full h-full">
              <img
          ...
          <div className="relative flex justify-between md:justify-center xl:justify-between w-full max-w-screen-lg h-[470px]">
            ...
            <div className="mx-12 md:mx-0 md:mr-2 xl:mr-4 max-w-xl w-full">
              ...
              <div className="flex items-left mt-10">
                {/* Get Started */}
                <NavLink to="/getstarted">
                  <button className="background3 hover:background text-white font-bold py-2 px-4 rounded">
                    Learn More
                  </button>
                </NavLink>
              </div>
